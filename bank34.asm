...
code_34825A:
  ...
  JSR code_348118                           ; $348269 |
  JMP code_34825A                           ; $34826C |

loc_6826F:
  JMP code_3481C7                           ; $34826F |

loc_68272:
  LSR $C4                                   ; $348272 |
  BCC loc_682A5                             ; $348274 |
  JSR code_348385                           ; $348276 |
  ASL                                       ; $348279 |
  ...
  INC $D6                                   ; $348286 |
loc_68288:
  JSR code_348385                           ; $348288 |
  TAX                                       ; $34828B |
  JSR code_348385                           ; $34828C |
  STA $D0                                   ; $34828F |
  STX $D1                                   ; $348291 |
...
loc_682A5:
  ...
  JSR code_348385                           ; $3482A9 |
  STA $D4                                   ; $3482AC |
loc_682AE:
  LSR $C4                                   ; $3482AE |
  BCC loc_682B7                             ; $3482B0 |
  JSR code_348385                           ; $3482B2 |
  STA $D2                                   ; $3482B5 |
loc_682B7:
  JSR code_348385                           ; $3482B7 |
  STA $D3                                   ; $3482BA |
  STA $C1                                   ; $3482BC |
  LDA $D4                                   ; $3482BE |
  STA $C4                                   ; $3482C0 |
  JSR code_348006                           ; $3482C2 |
  LDY $C1                                   ; $3482C5 |
  INY                                       ; $3482C7 |
  STY $D5                                   ; $3482C8 |
  INC $C0                                   ; $3482CA |
  JSR code_348385                           ; $3482CC |
  PHA                                       ; $3482CF |
  EOR $CF                                   ; $3482D0 |
  BEQ loc_682D9                             ; $3482D2 |
  STA $CF                                   ; $3482D4 |
  JSR code_3481D3                           ; $3482D6 |
loc_682D9:
  PLA                                       ; $3482D9 |
  STA $CF                                   ; $3482DA |
  RTS                                       ; $3482DC |
...
code_3482DD:
  ...
  JSR code_348683                           ; $3482E2 |
loc_682E5:
  LDA $C0                                   ; $3482E5 |
  LSR                                       ; $3482E7 |
  BCS loc_68309                             ; $3482E8 |
  JSR code_3486B9                           ; $3482EA |
  LDA $D3                                   ; $3482ED |
...
loc_682FF:
  ...
  JMP code_3485A2                           ; $348306 |

loc_68309:
  LDA #$00                                  ; $348309 |
  STA $C4                                   ; $34830B |
  JSR code_348385                           ; $34830D |
loc_68310:
  LSR                                       ; $348310 |
  BCC loc_6831F                             ; $348311 |
  PHA                                       ; $348313 |
  JSR code_348385                           ; $348314 |
  STA $C3                                   ; $348317 |
  LDA $C4                                   ; $348319 |
  JSR code_348325                           ; $34831B |
  PLA                                       ; $34831E |
loc_6831F:
...
code_348325:
  JSR code_348023                           ; $348325 |

  db $6E, $86, $AC, $86, $59, $86, $A6, $86 ; $348328 |
  db $A0, $86                               ; $348330 |

loc_68332:
  JSR code_348385                           ; $348332 |
  TAY                                       ; $348335 |
...
loc_6835A:
  ...
  JSR code_3485AD                           ; $348364 |
loc_68367:
  JMP code_348643                           ; $348367 |

loc_6836A:
  JSR code_3485AD                           ; $34836A |
  LDA #$FF                                  ; $34836D |
  STA $077C,x                               ; $34836F |
  DEY                                       ; $348372 |
  TXA                                       ; $348373 |
  ...
  TYA                                       ; $348378 |
  EOR #$0F                                  ; $348379 |
  JMP code_348635                           ; $34837B |

loc_6837E:
  TYA                                       ; $34837E |
  CLC                                       ; $34837F |
  ADC $D2                                   ; $348380 |
  JMP code_3485DD                           ; $348382 |
...
code_348392:
  ...
  JSR code_348683                           ; $3483A8 |
  JSR code_3486B9                           ; $3483AB |
loc_683AE:
  LDA $0740,x                               ; $3483AE |
  SEC                                       ; $3483B1 |
  SBC $C7                                   ; $3483B2 |
...
loc_683CC:
code_3483CC:
  JSR code_348591                           ; $3483CC |
  CMP #$20                                  ; $3483CF |
  BCS loc_683D9                             ; $3483D1 |
  JSR code_348496                           ; $3483D3 |
  JMP code_3483CC                           ; $3483D6 |
...
loc_68405:
  ...
  JSR code_3485A2                           ; $348412 |
  JMP code_348490                           ; $348415 |
...
loc_68429:
  ...
  JSR code_348643                           ; $348439 |
  JMP code_34847D                           ; $34843C |

loc_6843F:
  JSR code_3485AD                           ; $34843F |
  LDA $CF                                   ; $348442 |
...
loc_68453:
  ...
  AND #$0F                                  ; $34845B |
  EOR #$0F                                  ; $34845D |
  JSR code_348635                           ; $34845F |
  JMP code_34847D                           ; $348462 |
...
code_348496:
  ...
  STA $C4                                   ; $34849A |
  JSR code_348591                           ; $34849C |
  STA $C3                                   ; $34849F |
  LDA $C4                                   ; $3484A1 |
loc_684A3:
  JSR code_348023                           ; $3484A3 |
...
loc_68546:
  ...
  STA $0744,y                               ; $34854E |
  JSR code_348574                           ; $348551 |
loc_68554:
  JSR code_348591                           ; $348554 |
  STA $C3                                   ; $348557 |
  JSR code_348591                           ; $348559 |
  STA $0728,x                               ; $34855C |
  LDA $C3                                   ; $34855F |
  STA $072C,x                               ; $348561 |
  RTS                                       ; $348564 |
